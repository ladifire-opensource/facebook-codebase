__d("MWChatMultitabTabsContainer.bs", ["React", "JSResource", "stylex", "bs_caml_option", 
	"MWThreadKey.bs", "MWChatThreadId.bs", "MWUIChatTabState.bs", 
	"MWChatInteraction.bs", "MWChatStateThread.bs", "BootloaderResource", 
	"MWThread_DEPRECATED.bs", "CometErrorBoundary.re", "CometPlaceholder.react", 
	"MWChatMultitabStateHook.bs", "MWChatTabContainerShared.bs", 
	"MWChatTabContainerLoading.bs", "CometContextualLayerAnchorRoot.re",
	 "CometHeroInteractionWithDiv.react", "CometTransientDialogProvider.react", 
	 "MWChatTabContainerWithEarlierLoading.bs", "useCometDisplayTimingTrackerForInteraction"], (function (a, b, c, d, e, f) {
	"use strict";
	var g, h = b("React"),
		i = {
			tray: {
