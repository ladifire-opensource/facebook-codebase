__d("CometAlbumGridLayout.react", ["fbt", "CometFeedAlbumGridWarningScreen.react", 
	"CometFeedFocusImage.react", "CometFeedUnitQueryVariablesContext", 
	"CometFeedVideoPlayerPlaceholder.react", "CometPressable.react", 
	"CometProductTagFunnelIDContext", "CometProductTagLoggingUtils", 
	"CometRelay", "CometTrackingCodeContext", "CometTrackingNodeProvider.react", 
	"CometTrackingNodesContext", "CometVisualCompletionAttributes", "React", 
	"ReactComposerCollageLayoutSelection", "VideoPlayerDefaultControls.react", 
	"VideoPlayerInteractionOverlay.react", "VideoPlayerPortalingPlaceInfoProvider.react",
	 "VideoPlayerRelay.react", "VideoPlayerSurface.react", 
	 "getAggregatedStoryTrackingNodeIndex", "gkx", "stylex", 
	 "useCometPhotoViewerPlaceholderPassthroughProps", "CometAlbumGridLayoutChild_photo.graphql",
	  "CometAlbumGridLayoutChild_video.graphql"], (function (a, b, c, d, e, f, g) {
	"use strict";
	e.exports = a;
	var h, i, j, k = b("React"),
		l = {
	...
	function a(a) {
		...
		var q = a.size;
		i = i || q < 2 ? b("ReactComposerCollageLayoutSelection").getBestUserCollageLayout(a) : b("ReactComposerCollageLayoutSelection").getBestPageCollageLayout(a);
	...
	function o(a) {
		...
		return k.jsxs(b("VideoPlayerSurface.react"), {
			children: [k.jsx(b("VideoPlayerInteractionOverlay.react").VideoPlayerInteractionOverlay, {}), k.jsx(b("VideoPlayerDefaultControls.react"), {})]
		})
	}
	...
	function c(a, c) {
		var d, e, f, p = a.adID,
			...
			z = a.subOrigin;
		a = a.urls;
		var A = k.useContext(b("CometTrackingCodeContext")),
			B = k.useContext(b("CometTrackingNodesContext")),
			C = k.useContext(b("CometFeedUnitQueryVariablesContext")),
			D = k.useContext(b("CometProductTagFunnelIDContext"));
		...
		H = k.useCallback(function () {
			return E != null && k.jsx(b("CometFeedVideoPlayerPlaceholder.react"), {
				video: E
			})
		}, [E]);
		var K = q.attachment;
		...
		I = E != null ? I ? k.jsx("span", babelHelpers["extends"]({}, b("CometVisualCompletionAttributes").IGNORE, {
			children: k.jsx(b("VideoPlayerRelay.react"), {
				canAutoplay: f,
				portalingEnabled: !0,
		...
		})) : k.jsx(b("CometFeedVideoPlayerPlaceholder.react"), {
			video: E
		}) : k.jsx(b("CometFeedFocusImage.react"), {
			focusX: (f = M) != null ? f : .5,
			focusY: (H = N) != null ? H : .5,
			imageHeight: O,
			imageWidth: K,
		...
		K = function () {
			if ((t === !0 || s === !0) && S != null) {
				...
				b("CometProductTagLoggingUtils").logProductTagPostClick(p, "CometAlbumGridLayout", D, "newsfeed", S, a)
			}
		};
		return k.jsxs("div", {
			className: (j || (j = b("stylex")))(l.gridCell),
			"data-testid": void 0,
			style: {
			...
			children: [k.jsxs(b("CometPressable.react"), {
				...
				linkProps: {
					...
					rel: n ? void 0 : "theater",
					url: a ? u < a.length ? a[u] : R : R
				},
				onPress: K,
				overlayPressedStyle: l.mediaPressed,
				ref: c,
				xstyle: l.imageButton,
				children: [I, H ? k.jsx("div", {
					className: (j || (j = b("stylex")))(l.overlay),
					children: k.jsx("div", {
						className: (j || (j = b("stylex")))(l.overlayText),
						children: g._("+{num}", [g._param("num", x)])
					})
				}) : null]
			}), d && S != null && k.jsx(b("CometFeedAlbumGridWarningScreen.react"), {
				media: d,
				mediaUrl: R
			}), k.jsx(b("CometRelay").MatchContainer, {
				match: d == null ? void 0 : d.copyright_banner_info
			})]
		}, P)
	}
	var p = k.forwardRef(c)
}), null);