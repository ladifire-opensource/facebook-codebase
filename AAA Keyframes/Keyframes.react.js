__d("Keyframes.react", ["FBLogger", "Keyframes", "createCancelableFunction", 
	"promiseDone", "react", "testID"], (function(a, b, c, d, e, f) {
	"use strict";
	var g, h = g || b("react");
	...
	a = function(a) {
		...
		d.render = function() {
			var a = this,
				...
				f = c.style;
			c = c.width;
			c = this.state.renderer ? null : this.state.error ? this.props.errorPlaceholder || h.jsx(j, {
				width: c,
				height: e
			}) : this.props.placeholder || h.jsx(i, {
				width: c,
				height: e
			});
			e = this.props.mutator && this.state.renderer && h.cloneElement(this.props.mutator, {
