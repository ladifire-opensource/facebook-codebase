__d("CometMediaEditor.react", ["fbt", 
	"BaseMultiStepContainer.react",
	 "CometComposerHeader.react", 
	 "CometMediaEditorEligibilityContext", 
	 "CometMediaEditorSaverContext", 
	 "CometMediaEditorUtils", 
	 "CometMediaEditorViewer.react", 
	 "CometMediaViewerLayoutSkeleton.react", 
	 "CometPhotoEditorEditedPhotoViewer.react",
	  "CometPhotoEditorToolbar.react", 
	  "CometPlaceholder.react", 
	  "CometVideoEditorToolbar.react", 
	  "CometVideoEditorUtils.react", 
	  "MediaEditorViewStateContext",
	   "MediaEditorViewStateDispatcherContext",
	    "MediaEditorViewStateReducerContext",
	     "React", "basicCoordinateTransform", 
	     "cometMediaEditorCanEditWithAnyToolEligibilityChecker", 
	     "cometMediaEditorCaptionEligibilityChecker",
	      "cometMediaEditorRotateEligibilityChecker", 
	      "cometMediaEditorUploadingEligibilityChecker", 
	      "getCometMediaEditorEligibility", 
	      "getOnNavigateAwayHandler",
	       "reduceMediaEditorViewState",
	        "shallowEqual", "stylex",
	         "unrecoverableViolation", 
	         "updateCometPhotoEditorTagsOnNavigation",
	          "updateCometVideoEditorTags",
	...
	function a(a) {
		...
		var l = a.isOnVideoLiteComposer,
			m = l === void 0 ? !1 : l;
		l = babelHelpers.objectWithoutPropertiesLoose(a, ["initialTool", "isDialog", "mediaAttachments", "onBack", "videoAttachmentMetadata", "isOnVideoLiteComposer"]);
