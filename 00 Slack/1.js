tQ8E: function (e, t, a) {
	...
	class list_List extends i.PureComponent {
		constructor(e) {
			...
			this.onItemContextMenu = this.onItemContextMenu.bind(this), this.onContentContextMenu = this.onContentContextMenu.bind(this), this.layout = e.layout || new m.a, this.node = null, this.contentNode = null, this.isSelecting = !1, this.selectionStart = null, this.selectionEnd = null, this.scrollStartTimeout = null, this.layout.setKeys(e.keys);
			var {
				start: t,
				end: a
		...
		onScroll(e) {
			this.onScrollEnd(), 
			this.scrollStartTimeout || this.isScrolling() || e.target !== this.getScrollerRef() || (this.scrollStartTimeout = setTimeout(this.onScrollStart, 100)), this.relayout(), this.props.onScroll(e, {
