__d("Tooltip.react", ["Arbiter", "ReactDOM", "SubscriptionsHandler", "TooltipData", "createTooltipPortal", "gkx", "ifRequired", "killswitch", "react"], (function(a, b, c, d, e, f) {
	var g, h = g || b("react");
	a = function(a) {
		...
		function c() {
			...
			return (c = d = a.call.apply(a, [this].concat(f)) || this, d.$1 = null, d.$2 = new(b("SubscriptionsHandler"))(), d.state = {
				visible: !1,
				wasEverVisible: !1
			}, d.tooltipEl = h.createRef(), c) || babelHelpers.assertThisInitialized(d)
		}
