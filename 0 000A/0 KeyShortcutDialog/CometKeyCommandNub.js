__d("CometKeyCommandNub.react", ["fbt", "CometCompactKeyCommandDisplay.react", 
	"CometHideLayerOnEscape.react", "CometKeyCommandSettingsContext", 
	"CometSearchKeyCommandWrapper.react", "FocusManager", "FocusRegion.react", 
	"FocusWithinHandler.react", "JSResourceForInteraction", 
	"cometGetKeyCommandConfig", "focusScopeQueries", "react", "useCometLazyDialog", "useGlobalKeyCommands"], (function(a, b, c, d, e, f, g) {
	"use strict";
	e.exports = a;
	var h, i = h || b("react"),
		j = b("JSResourceForInteraction")("CometKeyShortcutDialog.react").__setRef("CometKeyCommandNub.react"),
		k = JSON.stringify({
	...
	function a() {
		var a = i.useContext(b("CometKeyCommandSettingsContext")),
			c = a.isViewerShowing,
			d = a.setViewerInfo,
			e = a.viewerType;
		a = b("useCometLazyDialog")(j);
		var f = a[0],
			g = i.useRef(null),
			h = i.useRef(!1),
			l = i.useCallback(function() {
				d(!1, e), e === "pinned" && h.current && g.current != null && b("FocusManager").focusElement(g.current, !0)
			}, [d, e]),
		...
		a = c && e === "pinned" ? i.jsx(b("CometCompactKeyCommandDisplay.react"), {
			onExpand: m,
			onHide: l
		}) : null;
		return i.jsx(b("FocusRegion.react").FocusRegion, {
			...
			children: i.jsx(b("CometSearchKeyCommandWrapper.react"), {
				children: i.jsx(b("FocusWithinHandler.react"), {
					...
					children: i.jsxs(b("CometHideLayerOnEscape.react"), {
						debugName: "KeyCommandNubESC",
						onHide: l,
						children: [a, i.jsx("div", {
							"data-at-shortcutkeys": k
						})]
					})
				})
			})
